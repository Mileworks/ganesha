package cn.com.epicc.ganesha.asset.service.impl;

import cn.com.epicc.ganesha.asset.dao.AccountIntegralDAO;
...
public class IntegralServiceImpl implements IIntegralService{
     ...
     */
    @Override
    public boolean trans(String from, String to, String value) {
        return false;
    }
